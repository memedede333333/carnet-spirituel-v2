...
export default function TestAnimation() {
  ...
  useEffect(() => {
    ...
    }, 8500) // Début du fondu vers homepage

    const redirectTimer = setTimeout(() => {
      window.location.href = '/'
    }, 10500) // Redirection après 2s de fondu
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {(animationPhase !== 'burst' && animationPhase !== 'reveal') && (
          <div style={{
            position: 'absolute',
            top: '50%',
            left: '50%',
        ...
        {(animationPhase !== 'burst' && animationPhase !== 'reveal') && spiritualElements.map((element, index) => {
      ...
      {/* Logo final avec rayons - après l'explosion */}
      ...
      {(animationPhase === 'reveal' || animationPhase === 'fadeout') && (
        <div style={{
          ...
          opacity: animationPhase === 'fadeout' ? 0 : 0 // Géré par animation fadeInUp initialement, puis par transition lors du fadeout
        }}>
          <div style={{
            opacity: animationPhase === 'fadeout' ? 0 : 1,
            transition: 'opacity 2s ease-out'
